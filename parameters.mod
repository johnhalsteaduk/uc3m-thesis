...
var C I_k K N R_k W Y D D_r Z Z_i Z_a I_zi I_za S T tau_c B C_r C_c R_b Q F;
varexo e_d e_crdc;

parameters alpha delta_k delta_za delta_zi eta psi rho_d rho_dr omega_tfp omega_s omega_r psi_z nu_a pi v tau_zi tau_za tau_c_target phi_c S_target L_ss R_star B_Y_ratio lambda_c nu_g eta_g delta_b phi_z rho_i;
...
% @#if HIGH_RISK == 1
%     omega_r = 10;    % Sovereign risk penalty factor
% @#else
%     omega_r = 0.5;
% @#endif
